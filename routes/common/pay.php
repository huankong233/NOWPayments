...
Route::group(['prefix' => 'pay', 'namespace' => 'Pay', 'middleware' => ['dujiaoka.pay_gate_way']], function () {
    ...
    // NOWPayments
    Route::get('nowpayments/{payway}/{orderSN}', 'NOWPaymentsController@gateway');
    Route::post('nowpayments/notify_url', 'NOWPaymentsController@notifyUrl');
    Route::get('nowpayments/return_url', 'NOWPaymentsController@returnUrl')->name('NOWPayments-return');
});